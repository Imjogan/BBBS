      ...
      <>
        <section className="two-columns two-columns_style_first">
          ...
          <Link to="#" className="link">
            <article className="block-photo">
              <h2 className="block-photo__title">
                {mainPageContent.history.title}
              </h2>
            </article>
          </Link>
        </section>
        <BigPlace place={mainPageContent.place} />
        <ArticleBlock
          className={"background-blue"}
          text={mainPageContent.articles[0].title}
        />
        ...
        <section className="two-columns two-columns_style_video-header">
          <article className="block-video-header block-video-header_type_description background-yellow">
            <h2 className="block-video-header__title">
              {mainPageContent.video.title}
            </h2>
            <p className="block-video-header__caption">
              {mainPageContent.video.info}
            </p>
            <a
              href={mainPageContent.video.link}
              className="block-video-header__category"
            >
              смотреть видео
            </a>
          </article>
          <article className="block-video-header">
            <iframe
              className="block-video-header__iframe"
        ...
        <ArticleBlock
          ...
          text={mainPageContent.articles[1].title}
        />
      </>
    );
  }
