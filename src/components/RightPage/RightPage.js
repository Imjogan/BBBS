...
const RightPage = () => {
  ...
  return (
    <section className="content-rights">
      <section
        className={`content__header content__header_style_rights-article background-${right.color}`}
      >
        <div
          className={`content__pseudo-blocks background-${right.color}`}
        ></div>
        <div className="content__wrapper">
          ...
          <p className="subtitle subtitle_style_rights-article">
            ...
            негативных особенностей: замедленный темп психического развития,
            низкий уровень интеллектуального развития, позднее формирование
            навыков саморегуляции и правил поведения, бедную эмоциональную сферу
            и воображение.
          </p>
        </div>
      </section>
      <section className="guide-article-description guide-article-description_style_rights-article guide-article-description_position_center">
        <div className="blocks-article">
          ...
          <p className="blocks-article__text">
            ...
            себя и окружающих. В ходе дальнейших взаимоотношений с окружающими
            негативное отношение к себе усиливается. Причиной формирования
            отрицательного образа себя, является также и недостаток безусловной
            любви, т. е. любви не за что-то, а просто, потому что он, ребенок,
            есть. И домашний ребенок может быть заброшен на няню, а в старшем
            возрасте безнадзорен.
          </p>
        </div>
        <div className="blocks-article">
          <h2 className="blocks-atricle__title blocks-atricle__title_style_guide-article">
        ...
        <div className="blocks-article">
          ...
          <p className="blocks-article__text blocks-article__text_type_accent background-yellow">
            Для воспитанников младшего школьного возраста характерны ярко
            выраженные мотивы, непосредственно связанные с их повседневной
            деятельностью в детском доме: выполнением режима проживания в
            детском доме, правил поведения в детском доме и в школе, тогда как у
            семейных детей этой возрастной группы мотивы их деятельности и
            общения значительно богаче и разнообразнее. Такая ограниченность и
            бедность мотивационной сферы связаны с условиями
            проживания&nbsp;детей&nbsp;в&nbsp;детском доме и их недостаточно
