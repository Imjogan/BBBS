...
export const getMainPageRes = {
  ...
  place: {
    ...
    imageUrl:
      "https://github.com/kalenimal/BBBS/blob/develop/src/images/block-place.jpg?raw=true",
...
export const getPlace = {
  id: 1,
  info: "Девочка, 10 лет. Познавательный отдых",
  chosen: true,
  title: "Детство",
...
export const getPlaces = {
  ...
  results: [
    ...
    {
      id: 2,
      info: "Мальчик, 10 лет. Активный отдых",
      chosen: false,
      title: "Солнце",
